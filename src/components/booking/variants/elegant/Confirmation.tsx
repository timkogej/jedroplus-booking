...
export default function Confirmation() {
  ...
  const handleConfirm = async () => {
    if (!selectedService || !selectedDate || !selectedTime) {
      setLocalError('Manjkajo potrebni podatki za rezervacijo');
      return;
    }
    ...
    try {
      ...
      setLocalError('Rezervacija ni uspela. Prosim poskusi znova.');
    }
  };
  ...
  const handleAddToCalendar = () => {
    ...
    const totalMin = hours * 60 + minutes + selectedService.duration;
    ...
    const icsContent = [
      ...
      `DESCRIPTION:Rezervacija storitve ${selectedService.name}`,
      'END:VEVENT',
      'END:VCALENDAR',
    ].join('\r\n');
            ...
            <div className="flex items-start gap-4 py-2">
              ...
              <div className="flex-1">
                ...
                <p className="text-white/40 text-sm">
                  <span className="font-light tracking-wider">{formatDuration(selectedService.duration)}</span>
                  {' · '}€{selectedService.price}
                </p>
              </div>
            </div>
          ...
          {selectedEmployee && (
            <div className="flex items-start gap-4 py-2">
              ...
              <div className="flex-1">
                ...
                <p className="font-serif text-lg text-white">{selectedEmployee.label || selectedEmployee.name}</p>
