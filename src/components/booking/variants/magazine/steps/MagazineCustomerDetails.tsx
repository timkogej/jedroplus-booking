        ...
        <form onSubmit={handleSubmit} className="flex-1 max-w-md">
          ...
          <motion.div variants={itemVariants} className="mt-8 space-y-4">
            <div className="space-y-1.5">
              <div className="flex items-start gap-3">
                <div
                  ...
                  onClick={() =>
                    setFormData((p) => ({
                      ...p,
                      gdprPrivacyConsent: !p.gdprPrivacyConsent,
                    }))
                  }
                >
                  <div
                    ...
                    style={{
                      borderColor: formData.gdprPrivacyConsent
                        ? theme.primaryColor
                        : 'rgba(0,0,0,0.2)',
                      backgroundColor: formData.gdprPrivacyConsent
                        ? `${theme.primaryColor}12`
                        : 'transparent',
                    }}
                  >
                    {formData.gdprPrivacyConsent && (
              ...
              {showPrivacyError && !formData.gdprPrivacyConsent && (
                <p className="text-red-500 text-[11px] ml-7 magazine-caps tracking-[0.1em]">
          ...
          <motion.div variants={itemVariants} className="mt-10">
            <motion.button
              ...
              className={`group relative px-8 py-3 overflow-hidden transition-all duration-300 ${!formData.gdprPrivacyConsent ? 'opacity-50 cursor-not-allowed' : ''}`}
              style={{ border: `1px solid ${theme.primaryColor}` }}
              whileHover={{ scale: formData.gdprPrivacyConsent ? 1.02 : 1 }}
              whileTap={{ scale: formData.gdprPrivacyConsent ? 0.98 : 1 }}
            >
              <motion.div
